...
export const UPGRADE_FLAVOR = {
  ...
  CONTRACTED_HIRELINGS: { name: 'Contracted Hirelings',      desc: '+1 gold per sec' },
  INSIGHTFUL_CONTRACTS: { name: 'Insightful Contracts',      desc: '+1 XP per bounty completed' },
  HIRELINGS_HIRELINGS:  { name: "Hireling's Hirelings",      desc: 'Each hireling gets this many hirelings, also generating +1 gold per sec' },
  ...
  CATS_SWIFTNESS:       { name: "Potion of Cat's Swiftness", desc: '-5% kobold respawn delay per level' },
  ...
  BETTER_TRACKING:      { name: 'Better Tracking',           desc: '+3% successful hunt chance' },
  ...
  BOUNTIFUL_LANDS:      { name: 'Bountiful Lands',           desc: '+1 resource tile per level' },
  ...
  TREASURE_CHEST:       { name: 'Treasure Chest',            desc: '+2% chance per level to find a treasure chest while hunting' },
  X_MARKS_THE_SPOT:     { name: 'X Marks the Spot',          desc: 'Treasure chests are marked with a red X' },
  ...
  // Apothecary
  POTION_TITRATION:     { name: 'Potion Titration',          desc: '+4% chance to save herbs when distilling' },
  POTION_MARKETING:     { name: 'Potion Marketing',          desc: '+1 gold per potion distilled' },
  FERMENTATION_VATS:    { name: 'Fermentation Vats',         desc: '+1 potion and -1 herb every 10 seconds. (toggleable)' },
  ...
  BIGGER_BUBBLES:       { name: 'Bigger Bubbles',            desc: 'Increase the size of the Bubbling zone' },
  POTION_DILUTION:      { name: 'Potion Dilution',           desc: '+1 concentrated potion, with a risk of failure (toggleable)' },
  SERIAL_DILUTION:      { name: 'Serial Dilution',           desc: '+1 additional independent potion roll per level when diluting' },
  PERFECT_POTIONS:      { name: 'Perfect Potions',           desc: 'Perfect clicks add +5% dilution success chance' },
  SYNAPTICAL_POTIONS:   { name: 'Synaptical Potions',        desc: 'Unlock the synaptical potion formula' },
  SYNAPTIC_STATIC:      { name: 'Synaptic Static',           desc: '+1 bonus zone when brewing synaptical potions' },
  ...
  LARGER_COOKBOOKS:     { name: 'Vintage Cookbook',          desc: 'The first ingredient in the recipe is always revealed' },
  COOKBOOK_ANNOTATIONS: { name: 'Annotated Cookbook',        desc: 'Each round begins with a free hint' },

  // Thief
  METICULOUS_PLANNING:      { name: 'Meticulous Planning',       desc: '+1% thieving success chance per level' },
  PLENTIFUL_PLUNDERING:     { name: 'Plentiful Plundering',      desc: '+1 gold equal per dossier collected, per level' },
  ...
  POTION_CATS_EARS:         { name: "Potion of Cat's Ears",      desc: '+3° sweet spot arc per level' },
  BAG_OF_HOLDING:           { name: 'Bag of Holding',            desc: 'Increased maximum gold and treasure yield' },
  RELIC_HUNTER:             { name: 'Relic Hunter',              desc: 'Allows the discovery of one additional relic!' },
  GEM_HUNTER:               { name: 'Gem Hunter',                desc: 'Reveals cryptic progress messages when completing gold bead challenges' },
  LOCKED_IN:                { name: 'Locked In',                 desc: 'Marks failed crack positions on the dial with a tick' },
  ...
  // Necromancer
  EXTENDED_RITUAL:          { name: 'Extended Ritual',           desc: '+2 actions before switching abilities per level' },
  DARK_PACT:                { name: 'Dark Pact',                 desc: '-2 XP cost per ward per level (min 1)' },
  AUGURY:                   { name: 'Augury',                    desc: 'Reveals how many actions remain before the active ability switches' },
  SPEAK_WITH_DEAD:          { name: 'Potion of Speak With Dead', desc: '+1 max bone yield per level' },
  FORTIFIED_CHALK:          { name: 'Fortified Chalk',           desc: '+1 max brimstone yield per level' },
  GRAVE_LOOTING:            { name: 'Grave Looting',             desc: '+5% chance per level to find bonus valuables while exhuming' },
  ...
  FIND_FAMILIAR:            { name: 'Find Familiar',             desc: 'Summon a spectral familiar for each character. Feed it Soul Stones for temporary +1 Jack power' },
  CONCENTRATED_SOULS:       { name: 'Concentrated Souls',        desc: '+15s Soul Stones duration when fed to a familiar' },
  VAULT_OF_SOULS:           { name: 'Vault of Souls',            desc: '+5 minutes max familiar time cap' },
  SPREADING_SOUL:           { name: 'Spreading Soul',            desc: 'Feed all familiars at once, distributing Soul Stones to the most needy first' },
  MIND_AND_SOUL:            { name: 'Mind and Soul',             desc: '+1 additional active familiar' },

  // Artificer
  DEEP_STUDY:               { name: 'Deep Study',                 desc: '+1 insight per Study' },
  FOCUSED_REFLECTION:       { name: 'Focused Reflection',         desc: '-1 minimum insight consumed per Reflect (min 1)' },
  AMPLIFIED_INSIGHT:        { name: 'Amplified Insight',          desc: '+1 bonus level added to insight before Reflecting' },
  POTION_ARCANE_INTELLECT:  { name: 'Potion of Arcane Intellect', desc: '+8 maximum insight. Does not effect consumption rate' },
  ...
  // Chimeramancer
  BIGGER_THREADS:           { name: 'Bigger Threads',  desc: '+1 Life Thread per stitch' },
  SHARPER_NEEDLES:          { name: 'Sharper Needles', desc: '+1 Life Thread per second' },
  LOOM_OF_LIFE:             { name: 'Loom of Life',    desc: 'Each Sharper Needle gets this many extra needles, each also generating +1 Life Thread per sec' },
  QUICK_STITCHING:          { name: 'Quick Stitching', desc: '2x the amount of resources applied per contribution' },
  MINOR_TOUCH_UP:           { name: 'Minor Touch Up',  desc: '+10% chance to apply +1 resource to a random other unfinished resource' },
  ...
  DIVERSIFIED_PORTFOLIO:    { name: 'Diversified Portfolio',       desc: 'Unlocks a new set of purchasable resources on the exchange' },
  STABLE_MARKET:            { name: 'Stable Market',               desc: '-1% max price on all stock market items' },


  // Slayer
  KNOW_NO_FEAR:       { name: 'Know No Fear',          desc: '+5 damage per attack' },
  BLOODLUST:          { name: 'Bloodlust',             desc: '-0.1s Slayer auto attack delay' },
  CONDEMN:            { name: 'Condemn',               desc: 'Clicking a weak spot grants +1 damage per level for 7s. Stacks up to 7x' },
  CONSECRATE:         { name: 'Consecrate',            desc: '+5s Condemn duration'},
  BANISHMENT:         { name: 'Banishment',            desc: '2x damage while all 7 Condemn stacks are active.' },
  WINDFURY:           { name: 'Windfury',              desc: '+10% chance to instantly trigger an extra attack each hit' },
...
export const CHARACTER_FLAVOR = {
  FIGHTER: {
    ...
    deathDesc: 'A butterfly flaps its wings, events set in motion cannot be stopped. A tragic tale, with humble beginnings, can you fault him for the death of all those who come after? ',
  ...
  RANGER: {
    ...
    deathDesc: 'The flesh of the beast belongs not to it, delivered and fleshcrafted into an amalgam. This sin represents the body of all beasts, and now, man too.',
    questBtn: 'Hunt & Gather',
  },
  APOTHECARY: {
    name: 'Apothecary',
    desc: 'Adventurers of all types stop in for a potion or two every now and then. He can give everyone something that itches that *personal* itch. ',
    deathDesc: 'His potions flow through the chimera\'s blood and mind. Every elixir he brewed now sustains the abomination. If only they were diluted further...',
    questBtn: 'Distill',
  },
  CULINARIAN: {
    name: 'Culinarian',
    desc: 'A seasoned chef who sources only the finest ingredients. People travel from far and wide seeking these exquisite tastes. Few are prepared for what they\'ll find...',
    deathDesc: 'His finest meals gave the chimera its strength. The spices he cherished now burn in its breath. The aromas led the masses to the site of their death.',
    questBtn: 'Source Ingredients',
  },
  THIEF: {
    name: 'Thief',
    desc: "A Lady doesn't need to always lurk in the shadows.",
    deathDesc: 'Perhaps some knowledge deserve to remain in the dark.',
    questBtn: 'Break & Enter',
  },
  ARTISAN: {
    name: 'Artisan',
    desc: 'A meticulous craftsman who sees value where others see junk. It takes one with *true* sight to understand the value of the unseen.',
    deathDesc: 'Luxury and craft are no help against the unseen foe. Perhaps his skills were too much for man to handle.',
    questBtn: 'Appraisal',
  },
  NECROMANCER: {
    name: 'Necromancer',
    desc: 'A scholar of the unholy arts. He commands the boundary between life and death, yet fails to connect with the living around him.',
    deathDesc: 'The bones of the chimera and his breath of brimstone belong not to him. The necromancer among the first to see the dead he loved so much...',
    questBtnExhume: 'Exhume',
    questBtnWard: 'Ward',
  },
  MERCHANT: {
    name: 'Merchant',
    desc: 'A cunning dealer who trades in goods others dare not touch. His connections span every dark corner of the nation.',
    deathDesc: 'Severed from his worldly connection, only the finest procured, only the finest slain by.',
    questBtn: 'Fence Goods',
  },
  ARTIFICER: {
    name: 'Artificer',
    desc: 'A scholar of arcane constructs. She strives for perfection, but for some reason refuses to achieve it. Her lab is surrounded by parts of nearly complete masterpieces.',
    deathDesc: 'Conjured mechanisms autonomized the massacre brought upon the world. If only she rejected perfection once more...',
    questBtnStudy: '>>> Study',
    questBtnReflect: 'Reflect <<<',
  },
  CHIMERAMANCER: {
    name: 'Chimeramancer',
    desc: 'A mad visionary who stitches flesh, bone, artifice, and spirit into a single impossible form. Thread by thread, a chimeric horror takes shape.',
    deathDesc: 'The first to see his creation, the first to be killed by it. Despite this, he seems sickly satisfied as he breathes his final breath...',
    questBtn: 'Stitch',
  },
  SLAYER: {
    name: 'Slayer',
    desc: 'The last one standing. There is only one thing left to do.',
    deathDesc: 'A Slayer cannot die.',
    questBtn: 'K I L L',
  },
} as const;
...
export const HERO_STATS_FLAVOR = {
  ...
  FIGHTER: {
    PER_CLICK:    'Gold/Bounty   :',
    PER_SECOND:   'Gold/Second  :',
  ...
  NECROMANCER: {
    ...
    BONE_PER_CLICK:   'Bone/Click :',
    BRIMSTONE_PER_W:  'Brimstone/Ward :',
...
export const BEAD_FLAVOR: Record<string, Record<string, BeadSlotFlavor>> = {
  /*
  * blue-1 - A brief intro to the character's personality
  * gold-1 - A hint to Gold-2
  * gold-2 - A sinister twist to the Patron's Goal
  * blue-2 - A positive takeaway from the Patron
   */
  fighter: {
    'blue-1': { name: 'Bead of Valor',          lore: 'The Fighter stands on principle, taking up jobs in service of those in need. Money is exchanged, yes, but it\'s all fair at the end of the day.',               effect: '2× resource yields from this character.' },
    'gold-1': { name: 'Bead of the Mercenary',  lore: '"I kill and I kill, one by one, by two, by three, by five. They fall after each other, and here I stand, a mercenary at best. Is this what I was destined for? Brutal kobold slaughter until a swarm does me in?" ',                        effect: 'The jacks assigned to this sidequest will work faster.' },
    'gold-2': { name: 'Bead of Supremacy',      lore: '"The demands of this Patron increase by the day. More and more dangerous tasks, and to what end? Here I am, risking life and limb for him, commanding others to do the same, for some cryptic clues about some sort of grand design. At least he follows through on his payments."',                                                                     effect: 'Attacks faster and auto-heals below half HP.' },
    'blue-2': { name: 'Bead of the Vanguard',   lore: '"It was one fateful day I received a particular job from a man only known as \'My Patron\'. I was tasked with gathering a crew of highly skilled craftsmen for a project larger than life. I have my question, but this is a sum of money I cannot turn down."',                   effect: '2× resource yields from this character (stacks).' },
  },
  ranger: {
  ...
  apothecary: {
    'blue-1': { name: 'Bead of Distillation',   lore: '"These fools are so unrefined, they couldn\'t tell a fine potion from their spit! To think, I could simply double my profit margins by selling them some watered down garbage!"',                         effect: '2× resource yields from this character.' },
    'gold-1': { name: 'Bead of the Alembic',    lore: '"I\'ve discovered a nearly perfect formula for my latest potion concoction! It turns out, you can maximize herb yield by steeping it alllmossst all the way to completion, reducing it down to nearly frozen temps, and then finishing it off with a perfect level of attention. Brilliant!',                                  effect: 'The jacks assigned to this sidequest will work faster.' },
    'gold-2': { name: 'Bead of Concentration',  lore: '"I find myself at an impasse, for this particular potion is not a potion at all! It\'s something else, something viscous and full of life, a nectar of sorts. For what use I cannot get this Parton to confess."',                                                                       effect: 'Ultra-fast auto-brew at 20 ms tick speed.' },
    'blue-2': { name: 'Bead of Refinement',     lore: '"For the first time in MANY years, I was approached by an odd man who knew what he wanted. What he *Actually* wanted. Something that even I had a hard time describing..."',                        effect: '2× resource yields from this character (stacks).' },
  },
  culinarian: {
    ...
    'gold-1': { name: 'Bead of the Hearth',     lore: '"Note from Mom - I\'ve slipped this note in your favorite cookbook! Hopefully one day you can put this modification to good use! I first start with a healthy dose of spice and fresh herbs. I then rub that mix on a double serving of kobold tongue and fresh meat. For good measure, I add a little more tongue, crusted in dried herbs, and some more meat, spiced with only the greatest!"',                                                   effect: 'The jacks assigned to this sidequest will work faster.' },
  ...
  thief: {
    'blue-1': { name: 'Bead of Shadows',        lore: 'Don\'t be fooled - This is not lowly thief. A Lady of the night holds the highest position in the land. Underlings do the dirty work, leaving the *real* work ',                      effect: '2× resource yields from this character.' },
    'gold-1': { name: 'Bead of the Unseen Hand',lore: 'You find behind a painting, a scribbled on a note. Who knows what it could mean... "9-3-9-10-6-9-3"',                                            effect: 'The jacks assigned to this sidequest will work faster.' },
    'gold-2': { name: 'Bead of the Ghost',      lore: 'How responsible is a Lady for her subjects? How do we weigh the success of the one great versus the lesser successes of the many? And who is a Lady to make that call?',                                                              effect: 'Deduces the sweet spot in two quick guesses, then cracks it.' },
    'blue-2': { name: 'Bead of the Fence',      lore: 'It\'s bold of one to ask such a Lady for help like this, but it\'s hard for someone like her to turn down such a bold request. Imagine the dirt you could gather from such an ambitious and well connected project.',                 effect: '2× resource yields from this character (stacks).' },
  },
  artisan: {
    ...
    'gold-1': { name: 'Bead of the Masterwork', lore: 'Etched in to a workstation, you see the following diagram: "Anchor: Top Left. Left. Up-Right. Left. Up. Right. Down. Left. Up-Left. Down."',                                  effect: 'The jacks assigned to this sidequest will work faster.' },
  ...
  necromancer: {
    'blue-1': { name: 'Bead of the Veil',       lore: 'The Necromancer is cast out from society, looked down upon in his grave, abandoned for the night he oh so loves. Despite the dangerous nature of his work, he finds himself underappreciated and alone. Or, that\'s what the unwise may say...',                              effect: '2× resource yields from this character.' },
    'gold-1': { name: 'Bead of Binding',        lore: '"The spirits have not been pleased with me recently... Their new graves are too close together, their souls are interfering with each other. I best accommodate them, and be sure NOT to streamline my process, just a time or three. Spread them out, let them breathe a little..."',                                   effect: 'The jacks assigned to this sidequest will work faster.' },
    'gold-2': { name: 'Bead of Dominion',       lore: '"I don\'t take kindly to the mistreatment of the dead. I find they are quite particular. I feel hollow and used after seeing what the Patron intends for. It\'s no way to treat a corpse..."',                                                                       effect: 'Always follows the optimal ritual path.' },
    'blue-2': { name: 'Bead of the Thrall',     lore: 'For the first time, someone recognized the necromancer\'s skills for what they are! To the right Patron, the manipulation of life energies could be invaluable!',                               effect: '2× resource yields from this character (stacks).' },
  },
  merchant: {
    'blue-1': { name: 'Bead of Fortune',         lore: 'Only the finest good can be sourced through, uh, \'less than legal\' means. ',                        effect: '2× resource yields from this character.' },
    'gold-1': { name: 'Bead of the Broker',      lore: '"Our patron has tasked me with acquiring the following: 10x herb, 10x Raw Meat, 5x Potions, 10x Spice, 10x Dossier (?), 5x lumps of Silver, 5x Onyx, 10x Bones, 10x Sulfur, and lastly, 5x Soul Stone. What could he *possibly* be doing? "',                           effect: 'Unlocks 1 auto-buyer on the stock market.' },
    'gold-2': { name: 'Bead of the Kingpin',     lore: 'Crates, carts, and vaults spilling over with goods and artifacts. No sane person would ever need such a mix of items. But this Patron... He\'s building something different. Something beyond our comprehension. But for what?',                                                               effect: 'Unlocks unlimited auto-buyers on the stock market.' },
    'blue-2': { name: 'Bead of the Cartel',      lore: '"I deal with strange, shady traders day in and day out, but this shadowy Paton even unsettles me. Never once have I ordered such large quantities of seemingly mundane objects."',                            effect: '2× resource yields from this character (stacks).' },
  },
  artificer: {
    'blue-1': { name: 'Bead of Arcana',          lore: 'She studies in her lab, surrounded by nearly complete inventions. A master craftsman, who has yet to complete a masterpiece. Is she deserving of that title?',                                           effect: '2× resource yields from this character.' },
    'gold-1': { name: 'Bead of the Automaton',   lore: 'LeftRightLeftRightLeftRightLeftRight I can\'t tell the difference between these things! Even to my eye, they all look the same! What does he see that I don\'t?',                         effect: 'The jacks assigned to this sidequest will work faster.' },
    'gold-2': { name: 'Bead of the Paradox',     lore: 'Or is the time not now? Should it have waited? Why pour ones time and expertise into something they themself don\'t want? A long awaited legacy bastardized by some other man\'s warped vision...',                                                        effect: 'Auto-etch never fails and yields bonus constructs.' },
    'blue-2': { name: 'Bead of the Workshop',    lore: 'This is it, it\'s now or never. The Patron has presented her with everything. The means, the resources, the motivation, and especially the pay. A masterpiece now.',                             effect: '2× resource yields from this character (stacks).' },
  },
  chimeramancer: {
    ...
    'gold-1': { name: 'Bead of Animation',       lore: 'I hear its heart beating. Thump. Thump. Thump. Thump. Thump. Like the second hand on a clock, it beats slow and steady.',                                                  effect: 'The jacks assigned to this sidequest will work faster.' },
    'gold-2': { name: 'Bead of the Chimera',     lore: 'I don\'t care what happens to me, everyone who helped me, everyone who gets hurt because of me! All that matters is this ONE. LAST. CREATION!',                                                                        effect: 'Resources applied to the chimera are free of cost.' },
  ...
  slayer: {
    ...
    'gold-1': { name: 'Bead of Carnage',         lore: 'The wrongs of the many will be rectified by the one.',              effect: 'Doubles the Slayer\'s attack damage.' },
    'gold-2': { name: 'Bead of Annihilation',    lore: '"Even if only I remain, I must kill."',            effect: 'Doubles the Slayer\'s attack damage (stacks with Bead of Carnage).' },
    'blue-2': { name: 'Bead of Relentlessness',  lore: 'This Nation must be saved.',    effect: '2× ichor gained from all attacks (stacks).' },
  },
};
...
export const GOLD2_STEP_MESSAGES: Record<string, string[]> = {
  fighter:     ['The blade remembers...',          'A sound of screams echos around you...',     'You see patterns in the bloodstains.',               'More stir in the stone.',  'Your mind screams, *KILL*'],
  ranger:      ['The forest stirs.',   'You retrace your footprints in the mud.',             'You\'ve seen that tree before.',           'Nature sings her song to you.',     'The stream beckons you to follow it.'],
  apothecary:  ['The cauldron smooths its surface.', 'The time for brewing is now!'],
  culinarian:  ['The flavor reminds you of home.', 'The texture reminds you of your first love.',           'The consistency is familiar'],
  thief:       ['The tumblers shift.',            'You hear a faint *Tick*.',          'The mechanism grinds.',              'Pins fall into place.',          'The safe trembles.',        'You hear a whirling',        'The latch begins to jiggle.'],
  artisan:     ['The gem glimmers in the light.',    'A facet twinkles in the air.',    'The jewel is warm to the touch.',  'You see visions of complex crystalline structures.',     'The cut is impossibly sharp.',      'The gem reflects your vision perfectly.', 'Brilliance overcomes you.', 'The smoothness is irresistible.', 'Your analysis is delecate.'],
  necromancer: ['The spirits are pleased.',        'You feel possessed by safety.',             'A positive omen appears.'],
  merchant:    ['The ledger fills out.',        'You strike a great deal!.', 'A new connection is made.',          'One of a kind!.',    'Another shipment settled.', 'He owed you that one.'],
  artificer:   ['The construct awakens with a hum.',            'A familiar symbol emerges.',      'The pattern reveals itself.',      'The etching glow with a brilliant blue.'],
  chimeramancer: ['The thread knots...',          'Flesh remembers its purpose.',   'The chimera stirs in its sleep.'],
};
