...
export const BEAD_FLAVOR: Record<string, Record<string, BeadSlotFlavor>> = {
  ...
  * blue-2 - A positive takeaway from the Patron
  ...
  necromancer: {
    ...
    'blue-2': { name: 'Bead of the Thrall',     lore: 'For or the first time, someone recognized the necromancer\'s skills for what they are! To the right Patron, the manipulation of life energies could be invaluable!',                               effect: '2× resource yields from this character (stacks).' },
  },
  merchant: {
