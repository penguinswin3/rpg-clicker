...
export const BEAD_FLAVOR: Record<string, Record<string, BeadSlotFlavor>> = {
  ...
  * blue-2 - A positive takeaway from the Patron
  ...
  fighter: {
    ...
    'gold-1': { name: 'Bead of the Mercenary',  lore: '"I kill and I kill, one by one, by two, by three, by five. They fall after each other, and here I stand, a mercenary at best. Is this what I was destined for? Brutal kobold slaughter until a swarm does me in?" ',                        effect: 'Unlocks basic sidequest automation.' },
  ...
  apothecary: {
    ...
    'gold-1': { name: 'Bead of the Alembic',    lore: '"I\'ve discovered a nearly perfect formula for my latest potion concoction! It turns out, you can maximize herb yield by steeping it alllmossst all the way to completion, reducing it down to nearly frozen temps, and then finishing it off with a perfect level of attention. Brilliant!',                                  effect: 'Unlocks basic sidequest automation.' },
  ...
  thief: {
    ...
    'gold-1': { name: 'Bead of the Unseen Hand',lore: 'You find behind a painting, a scribbled on a note. Who knows what it could mean... "9-3-9-10-6-9-3"',                                            effect: 'Unlocks basic sidequest automation.' },
  ...
  artificer: {
    ...
    'gold-1': { name: 'Bead of the Automaton',   lore: 'LeftRightLeftRightLeftRightLeftRight I can\'t tell the difference between these things! Even to my eye, they all look the same! What does he see that I don\'t?',                         effect: 'Unlocks basic sidequest automation.' },
  ...
  chimeramancer: {
    ...
    'gold-1': { name: 'Bead of Animation',       lore: 'Look upon my works and despair!',                                                  effect: 'Auto applies resources to the chimera.' },
